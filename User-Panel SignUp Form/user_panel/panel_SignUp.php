                ...
                <form action="#">
                    <div class="signup-penel-content-info form-group">
                        ...
                        <div class="signup-panel-input-form-box">
                            ...
                            <select name="" class="form-control" id="branch" required
                        ...
                        <div class="signup-panel-input-form-box form-group">
                            ...
                            <select class="form-control" id="course" onchange="other()" required
...
<script>
    ...
    function other() {
        var uniOther = document.getElementById("branch");
        var courseOther = document.getElementById("course");
        var uniName = document.getElementById("uniName");
        var courseName = document.getElementById("courseName");
        if(uniOther.value == "uni-other") {
            uniName.style.visibility="visible";
            uniName.style.height="100%";
        }
        if(courseOther.value == "course-other") {
            courseName.style.visibility="visible";
            courseName.style.height="100%";
        }
    }
